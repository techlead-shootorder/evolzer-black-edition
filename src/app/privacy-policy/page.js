    ...
    <>
      ...
      <div className="container py-10 font-sans">
        ...
        <p className="mb-4 text-white">
          ...
          its normal operation. This information will NOT be shared with
          third-party organizations unless we are obliged to by the relevant
          law.
        </p>
        ...
        <p className="mb-4 text-white">
          ...
          files sent to your browser and stored on your computer. If you do not
          want ShootOrder Technology LLP to send cookies to your browser, you
          can set your browser options to reject cookies or notify you when a
          website tries to put a cookie into your browser software. Rejecting
        ...
        <p className="mb-4 text-white">
          ...
          Technology LLP uses this information to improve our services,
          understand website traffic, and the use of downloads from our website.
          We are always seeking to improve our online presence to provide the
          best online experience possible for our customers.
        </p>
        ...
        <p className="mb-4 text-white">
          ...
          about other products and services that we think you may find to be of
          interest. If you wish to change the types of communications you
        ...
        <p className="mb-4 text-white">
          ...
          Technology LLP will not disclose your personal information to third
        ...
        <p className="mb-4 text-white">
          ...
          routine administration. If ShootOrder Technology LLP is ever sold to
        ...
        <p className="mb-4 text-white">
          ...
          We are constantly improving and enhancing our services and may update
          this privacy policy from time to time. Any changes to the policy will
          be reflected on an updated page on our website. If you have any
          queries or comments concerning our privacy policy, please contact us
