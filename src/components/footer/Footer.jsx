...
const Footer = () => {
  ...
  return (
    <footer className="footer-area bg-[#2F2B28] text-white py-10">
      <div className="container mx-auto">
        <div className="flex flex-wrap justify-center">
          <div className="w-full lg:w-1/4 p-4">
            <div className="single-footer-widget text-left">
              <div className="logo mb-4">
                <img src={"/images/logos/logo-w.png"} alt="logo" className="logo-item" loading="lazy" />
              </div>
          ...
          <div className="w-full lg:w-1/4 p-4">
            <div className="single-footer-widget">
              ...
              <ul className="list ">
                ...
                <li><Link href="/mobile-application" className="hover:underline text-white">Mobile Application</Link></li>
                <li><Link href="/web-development" className="hover:underline text-white">Web Development</Link></li>
                <li><Link href="/software-development" className="hover:underline text-white">Software Development</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/4 p-4">
            <div className="single-footer-widget">
              ...
              <ul className="list">
                ...
                <li><Link href="/term-condition" className="hover:underline text-white">Terms & Condition</Link></li>
                <li><Link href="/contact" className="hover:underline text-white">Contact Us</Link></li>
              </ul>
            </div>
          </div>
            ...
            <div className="single-footer-widget">
              ...
              <ul className="footer-contact-info">
                ...
                <li>
                  ...
                  Email: <a href="mailto:info@evolzer.com" className="hover:underline !text-white">info@evolzer.com</a>
                </li>
                <li>
                  <Icon.FaPhone className="inline-block mr-2 transform rotate-90" /> {/* Rotated the phone icon */}
                  Phone: <a href="tel:+91-630-392-1512" className="hover:underline !text-white">+91-630-392-1512</a>
                </li>
              </ul>

              <ul className="social-links flex space-x-4 mt-3 text-white">
                <li>
          ...
          <div className="mt-10 text-center">
            <p className="text-sm text-white">
              ...
              <a href="https://shootorder.com" target="_blank" rel="noreferrer" className="text-orange-500 hover:underline">
                Shootorder
              </a>
            </p>
          </div>
